...
<body class="bg-neutral-100 flex items-center justify-center h-screen">
    <div class="bg-white p-8 rounded-lg shadow-md w-full max-w-md">
        <h2 class="text-2xl font-bold mb-4 text-neutral-800">Login</h2>
        <?php App::flashErrors(); ?>
        <form action="handlers/login.php" method="POST" class="space-y-4">
            <div>
            ...
            <button type="submit" class="w-full bg-indigo-600 text-white py-2 px-4 rounded hover:bg-indigo-700">Login</button>
        </form>
